...
class Conv2DResBlock(Conv2DBlock):
    ...
    def __init__(self, filters: int, kernel_size: int = 3, activ_type = ACT_RELU, group_size: int = 4, block_type = RES_TYPE_ORIGIN, input_filters: int = None, drop_rate: float = 0.0, **kwargs):
        super(Conv2DResBlock, self).__init__(filters=filters, kernel_size=kernel_size, **kwargs)
...
class Conv2DResDownBlock(Conv2DResBlock):
    ...
    def __init__(self, filters: int, pool_size: int = 2, kernel_size: int = 3, activ_type=ACT_RELU, group_size: int = 4, block_type=RES_TYPE_ORIGIN, input_filters: int = None, drop_rate: float = 0, **kwargs):
        super(Conv2DResDownBlock, self).__init__(filters, kernel_size, activ_type, group_size, block_type, input_filters, drop_rate, **kwargs)
...
class Conv2DResUpBlock(Conv2DResBlock):
    ...
    def __init__(self, filters: int, sample_size: int = 2, kernel_size: int = 3, activ_type=ACT_RELU, group_size: int = 4, block_type=RES_TYPE_ORIGIN, input_filters: int = None, drop_rate: float = 0, **kwargs):
        super(Conv2DResUpBlock, self).__init__(filters, kernel_size, activ_type, group_size, block_type, input_filters, drop_rate, **kwargs)
